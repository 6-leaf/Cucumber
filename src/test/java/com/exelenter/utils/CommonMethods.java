...
public class CommonMethods extends PageInitializer {
    ...
    /**
     * This method take a screenshot based on the given element
     *
     * @param element  which is screenshot needs to be taken
     * @param fileName screenshot file name, defaulted to .png format (can be changed any format within the method.)
